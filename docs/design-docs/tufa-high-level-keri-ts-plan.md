...
- CESR Parser
- keystore and key management
- AID creation and management (incept, rotate, interact)
- multisig support
- ACDC credential issuance (registry TEL, ACDC TEL, ACDC Schema, ACDCs)
- mailbox
- witness
- watcher
- adjudicator
- observer
- registrar
- did:webs dynamic asset generator
- did:webs resolver
