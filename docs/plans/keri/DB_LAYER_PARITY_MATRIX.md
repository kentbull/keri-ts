...
| `dbing.py`     | `def`       | `splitOnKey`        |         171 | `DB-CORE`   | `keripy/src/keri/db/dbing.py`     | `packages/keri/src/db/core/keys.ts`             | `splitOnKey (planned)`        | `D1`  | `Missing` | Top-level symbol inventory row                      |
...
| `dbing.py`     | `def`       | `clearDatabaserDir` |         252 | `DB-CORE`   | `keripy/src/keri/db/dbing.py`     | `packages/keri/src/db/core/path-manager.ts`     | `clearDatabaserDir (planned)` | `D1`  | `Missing` | Top-level symbol inventory row                      |
| `dbing.py`     | `def`       | `openLMDB`          |         261 | `DB-CORE`   | `keripy/src/keri/db/dbing.py`     | `packages/keri/src/db/core/lmdber.ts`           | `openLMDB helper (planned)`   | `D1`  | `Missing` | Top-level symbol inventory row                      |
