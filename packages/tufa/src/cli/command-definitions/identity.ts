...
function registerAnnotateCmd(
  ...
  registerDispatchedCommand(
    ...
    dispatch,
    {
      name: "saidify",
      load: () => import("keri-ts/cli"),
      exportName: "saidifyCommand",
      args: (options: { file: string; label?: string }) => ({
        file: options.file,
        label: options.label,
      }),
    },
