...
export function registerMailboxCmds(
  ...
  registerDispatchedCommand(
    ...
    {
      name: "mailbox.start",
      load: () => import("../mailbox.ts"),
      exportName: "mailboxStartCommand",
  ...
  registerDispatchedCommand(
    ...
    dispatch,
    {
      name: "mailbox.remove",
      load: () => import("../mailbox.ts"),
      exportName: "mailboxRemoveCommand",
      args: (options: Record<string, unknown>) => ({
        name: options.name,
        alias: options.alias,
        mailbox: options.mailbox,
  ...
  registerDispatchedCommand(
    ...
    dispatch,
    {
      name: "mailbox.update",
      load: () => import("../mailbox.ts"),
      exportName: "mailboxUpdateCommand",
      args: (options: Record<string, unknown>) => ({
        name: options.name,
        alias: options.alias,
  ...
  registerDispatchedCommand(
    ...
    dispatch,
    {
      name: "mailbox.debug",
      load: () => import("../mailbox.ts"),
      exportName: "mailboxDebugCommand",
      args: (options: Record<string, unknown>) => ({
        name: options.name,
        alias: options.alias,
        witness: options.witness,
