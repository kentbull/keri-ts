...
import { registerMultisigCmd } from "./multisig.ts";
...
function registerInitCmd(program: Command, dispatch: CommandDispatch): void {
  ...
  registerCommandHandler("init", () => import("keri-ts/cli"), "initCommand");
}
...
function registerInceptCmd(program: Command, dispatch: CommandDispatch): void {
  ...
  registerCommandHandler("incept", () => import("keri-ts/cli"), "inceptCommand");
}
...
function registerRotateCmd(program: Command, dispatch: CommandDispatch): void {
  ...
  registerCommandHandler("rotate", () => import("keri-ts/cli"), "rotateCommand");
}
...
function registerInteractCmd(
  ...
  registerCommandHandler("interact", () => import("keri-ts/cli"), "interactCommand");
}
...
function registerDelegateCmd(
  ...
  registerCommandHandler("delegate.confirm", () => import("keri-ts/cli"), "delegateConfirmCommand");
}
...
function registerAgentCmd(program: Command, dispatch: CommandDispatch): void {
  ...
  registerCommandHandler("agent", () => import("../agent.ts"), "agentCommand");
}
