...
describe("Integration: Server", () => {
  it("startServer with HTTP requests", async () => {
   ...
   */
  it("startServer with concurrent requests", async () => {
    const testPort = 8002;
   ...
   */
  it("startServer error handling", async () => {
    const testPort = 8003;
