import { reset, shift } from "./deps.js";
...
export function action(operation) {
    return instruction(function Action(frame) {
        return shift(function* (k) {
            let settle = yield* reset(function* () {
                let result = yield* shiftSync((k) => k.tail);
 ...
 */
export function resource(operation) {
    return instruction((frame) => shift(function (k) {
...
export function getframe() {
    return instruction((frame) => shiftSync((k) => k.tail(Ok(frame))));
}
