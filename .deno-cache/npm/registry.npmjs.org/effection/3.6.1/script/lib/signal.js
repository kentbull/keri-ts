...
exports.SignalQueueFactory = void 0;
 ...
 * ```
 */
exports.SignalQueueFactory = (0, context_js_1.createContext)("Signal.createQueue", queue_js_1.createQueue);
/**
...
function createSignal() {
    ...
    let subscribe = (0, instructions_js_1.resource)(function* (provide) {
        let newQueue = yield* exports.SignalQueueFactory.expect();
        let queue = newQueue();
